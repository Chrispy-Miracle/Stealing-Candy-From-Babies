...
PLAYER_BALLOON_OFFSET_X = 13
PLAYER_BALLOON_OFFSET_Y = -2

ROTATED_BALLOON_OFFSET_X = 15 
ROTATED_BALLOON_OFFSET_Y = 30 

PLAYER_LOLLIPOP_OFFSET_X = 7
PLAYER_LOLLIPOP_OFFSET_Y = 12
...
PLAYER_BONK_DISTANCE = 10
BABY_BONK_DISTANCE = 5
